...
<!-- BEGIN: nosaved -->
<div id="kayit_ok_Content">
    <div class="baslik">KAYIT İŞLEMİNİZ BİR HATADAN DOLAYI GER&Ccedil;EKLEŞTİRİLEMEMİŞTİR !</div>
    <div class="aciklamasi">
        <p>Sayın {username}, hesabınız oluşturulamadı. Lütfen girmiş olduğunuz bilgilerin doğruluğunu kontrol ediniz ve tekrar deneyiniz.</p>
        <p>Hizmetlerimize göstermiş olduğunuz ilgi için teşekkür ederiz.</p>
    </div>
</div>
<!-- END: nosaved -->
