...
$query="select ro.* from offers o, reoffers ro where o.status=3 and ro.status=0 and o.domain_id=ro.domain_id and o.id=ro.offer_id";
...
$header->assign("cls_teklif_out", 'active');
$header->parse("main");
