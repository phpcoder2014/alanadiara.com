    ...
    <div class="table">
        ...
        <table class="listing" cellpadding="0" cellspacing="0">
            ...
            <tr class="{bg}">
                ...
                <td>{price} $</td>
                <td>{time}</td>
                <td><a href="#" onclick="return false;"><img src="img/edit-icon.gif" alt="detay" onclick="popup('offer_info.php?offerid={offerid}', 'detay')"/></a></td>
                <td>
                    <!-- BEGIN: aktif -->
                    ...
                    <!-- END: aktif -->
                    <!-- BEGIN: cancel -->
                    <p class="iptal" onclick="offer_actions({offerid}, 'delete');"><a href="javascript:void(0);"><span id="{offerid}">İptal</span></a><br></p>
                    <!-- END: cancel -->
                    <!-- BEGIN: tasima -->
